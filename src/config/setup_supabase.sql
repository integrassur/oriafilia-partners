...
-- Trigger de sécurité pour empêcher l'escalade de privilèges
...
-- Trigger de sécurité pour protéger les champs financiers et le statut
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    -- On s'assure qu'il crée bien pour lui-même
